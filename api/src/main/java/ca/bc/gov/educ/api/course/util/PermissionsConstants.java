...
public interface PermissionsConstants {
	...
	String UPDATE_GRAD_COURSE_RESTRICTION = _PREFIX + "UPDATE_GRAD_COURSE_RESTRICTION_DATA" + _SUFFIX;
	String READ_GRAD_STUDENT_EXAM = _PREFIX + "READ_GRAD_STUDENT_EXAM_DATA" + _SUFFIX;
}
