...
public class CourseRestrictionsTransformer {
    ...
    public CourseRestriction transformToDTO (CourseRestrictionsEntity courseRestrictionsEntity) {
        ...
        courseRestrictions.setRestrictionStartDate(EducCourseApiUtils.parseTraxDate(courseRestrictionsEntity.getRestrictionStartDate() != null ? courseRestrictionsEntity.getRestrictionStartDate().toString():null));
        courseRestrictions.setRestrictionEndDate(EducCourseApiUtils.parseTraxDate(courseRestrictionsEntity.getRestrictionEndDate() != null ? courseRestrictionsEntity.getRestrictionEndDate().toString():null));
    ...
    public CourseRestriction transformToDTO ( Optional<CourseRestrictionsEntity> courseRestrictionsEntity ) {
        ...
        courseRestrictions.setRestrictionStartDate(EducCourseApiUtils.parseTraxDate(cae.getRestrictionStartDate() != null ? cae.getRestrictionStartDate().toString():null));
        courseRestrictions.setRestrictionEndDate(EducCourseApiUtils.parseTraxDate(cae.getRestrictionEndDate() != null ? cae.getRestrictionEndDate().toString():null));
        return courseRestrictions;
    }
	...
	public List<CourseRestriction> transformToDTO (Iterable<CourseRestrictionsEntity> courseReqEntities ) {
        ...
        for (CourseRestrictionsEntity courseReqEntity : courseReqEntities) {
            ...
            courseRestrictions.setRestrictionStartDate(EducCourseApiUtils.parseTraxDate(courseReqEntity.getRestrictionStartDate() != null ? courseReqEntity.getRestrictionStartDate().toString():null));
            courseRestrictions.setRestrictionEndDate(EducCourseApiUtils.parseTraxDate(courseReqEntity.getRestrictionEndDate() != null ? courseReqEntity.getRestrictionEndDate().toString():null));
    ...
    public CourseRestrictionsEntity transformToEntity(CourseRestriction courseRestrictions) {
        ...
        courseRestrictionsEntity.setRestrictionStartDate(courseRestrictions.getRestrictionStartDate() != null ?Date.valueOf(courseRestrictions.getRestrictionStartDate()) : null);
        courseRestrictionsEntity.setRestrictionEndDate(courseRestrictions.getRestrictionEndDate() != null ?Date.valueOf(courseRestrictions.getRestrictionEndDate()) : null);
